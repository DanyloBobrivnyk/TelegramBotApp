...
namespace TechnicalProcessControl.BLL.Services
{
    public class MySqlService : IMySqlService
    {
        ...
        public MySqlService(IUnitOfWorkMysql uowsql)
        {
            ...
            {
                cfg.CreateMap<TelegramBot, DishDTO>();
                cfg.CreateMap<DishDTO, TelegramBot>();
        ...
        public int? GetProductionId(string productionName)
        {
            ...
            List<ProductionDTO> hjhjh = mapper.Map<IEnumerable<Production>, List<ProductionDTO>>(production.GetAll()).ToList();
        ...
        public bool CheckMessages()
        {
            ...
            bool newBool = checkMessage ?? true;
        ...
        public bool ContainMessages(long telegramId)
        {
            ...
            bool newBool = checkMessage ?? false;
        ...
        public int TelegramBotCreate(DishDTO telegramBotDTO)
        {
        ...
        public void TelegramBotUpdate(DishDTO telegramBotDTO)
        {
            var updatetelegramBot = telegramBot.GetAll().SingleOrDefault(c => c.Id == telegramBotDTO.ID);
            telegramBot.Update((mapper.Map<DishDTO, TelegramBot>(telegramBotDTO, updatetelegramBot)));
        }
